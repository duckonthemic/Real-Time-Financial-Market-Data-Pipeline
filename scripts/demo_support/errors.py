...
class ConfigFailure(DemoFailure):
    def __init__(
        ...
        message: str,
        phase: str = "preflight",
        remediation: str = "Fix config/demo.toml and rerun.",
    ):
...
class InvariantFailure(DemoFailure):
    def __init__(
        ...
        message: str,
        phase: str = "verifying",
        remediation: str = "Open run-report.json for the failed invariant.",
    ):
...
class DeadlineFailure(DemoFailure):
    def __init__(
        ...
        message: str,
        phase: str,
        remediation: str = "Inspect captured service logs and retry with healthy resources.",
    ):
